...
<script type="text/javascript" src="/mb/resources/js/drag.js"></script>
<script type="text/javascript" src="/mb/resources/plugin/swfupload2/swfupload.js"></script>
<script type="text/javascript" src="/mb/resources/plugin/swfupload2/swfupload.queue.js"></script>
<script type="text/javascript" src="/mb/resources/plugin/swfupload2/handlers.js"></script>
<script type="text/javascript" src="/mb/resources/plugin/swfupload2/fileprogress.js"></script>
...
var upLoadBox = {
		...
		init: function(options) {
			var self = this;
			var defaults = {
				flash_url: "/mb/resources/plugin/swfupload2/swfupload.swf",
				flash9_url: "../swfupload/swfupload_fp9.swf",
				upload_url: "/mb/resources/plugin/swfupload2/upload",                               //asp上传程序
				post_params: {
					"PHPSESSID": ""
				},
				file_size_limit: 0,
				...
				// Button settings
				button_image_url: "/mb/resources/plugin/swfupload2/XPButtonNoText_61x22.png",
				button_width: "61",
				button_height: "22",
	 ...
	 window.onload = function() {
		       //swfupload 设置
				var settings = {
					flash_url : "/mb/resources/plugin/swfupload2/swfupload.swf",
					flash9_url : "../swfupload/swfupload_fp9.swf",
					upload_url: "/mb/prototype/upload",
